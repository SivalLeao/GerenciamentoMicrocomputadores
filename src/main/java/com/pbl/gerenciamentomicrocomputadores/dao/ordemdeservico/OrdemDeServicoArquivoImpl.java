...
public class OrdemDeServicoArquivoImpl implements OrdemDeServicoDAO {
    ...
    public Map<Integer, Integer> OrdensUtilizandoPeca(String nomePeca) {
        ...
        for (OrdemDeServico ordemDeServico: this.lista) {
            ...
            if ((ordemDeServico.getStatusAtual().equals("Em espera") || ordemDeServico.getStatusAtual().equals("Em andamento"))
                    && ordemDeServico.getDescricaoServico().getTipoDeServico().equals("Montagem/Instalação")) {
